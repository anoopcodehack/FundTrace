    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-[#09090b]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center mt-20">
        ...
        <motion.h1
          ...
          className="text-6xl sm:text-7xl md:text-8xl font-black tracking-tighter text-white mb-6 uppercase font-bebas leading-[0.85]"
        >
          Zero Trust. <br />
        ...
        <motion.p
          ...
          className="text-sm md:text-lg text-stone-400 max-w-2xl mx-auto mb-10 leading-relaxed font-medium"
        >
        ...
        >
          ...
          <Link href="/create">
            <Button size="lg" variant="outline" className="h-14 px-8 text-base rounded-full bg-white/5 border-white/10 text-white hover:bg-white/10 hover:text-white backdrop-blur-sm">
      ...
      <motion.div 
        ...
        className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/3 w-[90%] md:w-[800px] h-[300px] bg-black/40 border border-white/10 rounded-t-3xl backdrop-blur-2xl shadow-2xl p-6 hidden md:block"
      >
