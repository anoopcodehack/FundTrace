        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-stone-300 pb-6">
            <div>
              ...
              <p className="text-stone-600 font-medium mt-2">Immutable on-chain events across all campaigns.</p>
            </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-stone-200 shadow-sm overflow-hidden">
            <div className="p-6 border-b border-stone-100 bg-stone-50/50 flex justify-between items-center">
              ...
              <span className="text-xs font-bold text-emerald-600 bg-emerald-100 px-3 py-1 rounded-full uppercase tracking-wider">Live Sync</span>
            </div>
            
            <div className="p-6 space-y-6">
              {MOCK_LEDGER_EVENTS.map((ev, idx) => (
              ...
              {MOCK_LEDGER_EVENTS.length === 0 && (
                <div className="text-center py-12 text-stone-500 font-medium">
                  No on-chain events found in the ledger.
                </div>
              )}
            </div>
          </div>
